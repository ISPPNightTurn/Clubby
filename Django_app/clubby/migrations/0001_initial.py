    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha', models.DateTimeField(default=datetime.datetime(2020, 3, 31, 15, 16, 2, 681454))),
                ('club', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='clubby.Club')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha', models.DateTimeField(default=datetime.datetime(2020, 3, 31, 15, 16, 2, 681898))),
