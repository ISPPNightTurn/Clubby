    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha', models.DateTimeField(default=datetime.datetime(2020, 3, 31, 22, 59, 1, 252323))),
                ('club', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='clubby.Club')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha', models.DateTimeField(default=datetime.datetime(2020, 3, 31, 22, 59, 1, 252999))),
