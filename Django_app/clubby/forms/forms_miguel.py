...
class SearchEventForm(forms.Form):
    ...
    start_date = forms.DateField(widget=AdminDateWidget(attrs={'class': 'datepicker inicio'}), help_text="We will start looking here.")
    end_date = forms.DateField(widget=AdminDateWidget(attrs={'class': 'datepicker fin'}), help_text="We stop looking here.")
