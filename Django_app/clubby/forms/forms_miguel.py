...
class SearchEventForm(forms.Form):
    ...
    start_date = forms.DateField(widget=AdminDateWidget(attrs={'class': 'datepicker inicio','readonly':'readonly','style': 'color: white'}), help_text=_("We will start looking here."))
    end_date = forms.DateField(widget=AdminDateWidget(attrs={'class': 'datepicker fin','readonly':'readonly','style': 'color: white'}), help_text=_("We stop looking here."))
...
class EditProfileForm(forms.Form):
    ...
    birth_date = forms.DateField(widget=DateInput(attrs={'class': 'datepicker','readonly':'readonly', 'style': 'color: white'}))
