...
def payout(request): # new
    ...
    if request.method == 'POST':
        ...
        if(quantity > funds):
            ...
            success_url='https://thatsclubby.herokuapp.com/',
            cancel_url='https://thatsclubby.herokuapp.com/profile',
            )
...
def connect_spotify(request):
    ...
    if(code != None):
        ...
        redirect_uri = 'https://thatsclubby.herokuapp.com/clubby/spotify/authorize/'
