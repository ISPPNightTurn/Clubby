...
class SignUpFormTest(TestCase):
    def test_sign_up_form_first_name_char_field_label(self):
        form = SignupForm()
        self.assertTrue(form.fields['first_name'].label ==
                        None or form.fields['first_name'].label == 'first_name')

    def test_sign_up_form_first_name_char_field_help_text(self):
        form = SignupForm()
        self.assertTrue(
            form.fields['first_name'].help_text, 'Required. 30 character max')
    ...
    def test_sign_up_form_bith_date_date_field_label(self):
        form = SignupForm()
        self.assertTrue(form.fields['birth_date'].label ==
                        None or form.fields['birth_date'].label == 'birth_date')

    def test_sign_up_form_birth_date_date_field_help_text(self):
        form = SignupForm()
        self.assertTrue(form.fields['birth_date'].help_text,
                        'Required, your birthday, format: YYYY-MM-DD')

    def test_sign_up_form_bio_char_field_label(self):
        form = SignupForm()
        self.assertTrue(form.fields['bio'].label ==
                        None or form.fields['bio'].label == 'bio')

    def test_sign_up_form_bio_char_field_help_text(self):
        form = SignupForm()
        self.assertTrue(form.fields['bio'].help_text,
                        'Optional, tell us something about you.')

    def test_sign_up_form_location_char_field_label(self):
        form = SignupForm()
        self.assertTrue(form.fields['location'].label ==
                        None or form.fields['location'].label == 'location')

    def test_sign_up_form_location_char_field_help_text(self):
        form = SignupForm()
        self.assertTrue(form.fields['bio'].help_text,
                        'Optional, where are you form?.')
...
class ProductModelFormTest(TestCase):
    ...
    def test_product_model_form_name_char_field_label(self):
        ...
        self.assertTrue(
            form.fields['name'].label == None or form.fields['location'].label == 'location')

    def test_product_model_form_name_char_field_help_text(self):
        form = ProductModelForm()
        self.assertTrue(form.fields['name'].help_text,
                        'Required. 50 character max')

    def test_product_model_form_price_decimal_field_label(self):
        form = ProductModelForm()
        self.assertTrue(form.fields['price'].label ==
                        None or form.fields['price'].label == 'price')

    def test_product_model_form_price_decimal_field_help_text(self):
        form = ProductModelForm()
        self.assertTrue(form.fields['price'].help_text,
                        'Required. 5 digits max')
...
class EventModelFormTest(TestCase):
    ...
    def test_event_model_form_name_char_field_label(self):
        ...
        self.assertTrue(form.fields['name'].label ==
                        None or form.fields['name'].label == 'name')
    ...
    def test_event_model_form_start_date_date_field_label(self):
        form = EventModelForm()
        self.assertTrue(form.fields['start_date'].label ==
                        None or form.fields['start_date'].label == 'price')
